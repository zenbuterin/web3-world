...
export function CreateProposalButton() {
    ...
    return (<div className="flex flex-col h-full">
        <button className="border-black border-3 w-20 text-black bg-white hover:bg-gray-600 hover:text-white rounded-lg h-40 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] 
